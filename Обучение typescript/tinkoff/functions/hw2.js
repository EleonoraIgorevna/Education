...
*/
var countFreq = function (arr) {
    var frequencies = {};
    var countFrequencies = (function (item) {
        if (frequencies[item]) {
            frequencies[item]++;
            return frequencies;
        }
...
var strings = ["мандариночка", "персик", "яблоко", "банан", "банан", "апельсин", "яблоко", "апельсин", "апельсин"];
var frequencies = countFreq(strings);
