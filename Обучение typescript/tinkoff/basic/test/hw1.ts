...
type type = operations.ADD | operations.SET | operations.REMOVE;
type operationsType = [type?, type?, type?]

interface schemaAndAllowedValues {
    type?: string
    system?: string
    items?: string
    id?: number
...
interface field {
    required: boolean
    schema: schemaAndAllowedValues
    name: string
    fieldId: string
    autoCompleteUrl?: string
    operations: operationsType
    allowedValues?: schemaAndAllowedValues[] | []
}
